...
function app() {
  return {
    ...
    init() {
      ...
      // Hash routing
      var validPages = ['overview','agents','sessions','approvals','comms','workflows','scheduler','channels','skills','hands','analytics','quality','logs','runtime','settings','vault','wizard'];
      var pageRedirects = {
        'chat': 'agents',
        'templates': 'agents',
        'triggers': 'workflows',

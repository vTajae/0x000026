...
pub struct OpenFangKernel {
    ...
    /// Provider circuit breaker — rate-limit cooldown tracking.
    pub provider_cooldown: openfang_runtime::auth_cooldown::ProviderCooldown,
...
impl OpenFangKernel {
    ...
    pub fn boot_with_config(mut config: KernelConfig) -> KernelResult<Self> {
        ...
        let kernel = Self {
            ...
            provider_cooldown: openfang_runtime::auth_cooldown::ProviderCooldown::new(
                openfang_runtime::auth_cooldown::CooldownConfig::default(),
            ),
    ...
    pub fn send_message_streaming(
        ...
        let handle = tokio::spawn(async move {
            ...
            let result = run_agent_loop_streaming(
                ...
                Some(&kernel_clone.provider_cooldown),
            )
            .await;
